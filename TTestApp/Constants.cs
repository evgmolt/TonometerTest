...
namespace TTestApp
{
    internal static class Constants
    {
        ...
        //Алгоритм
        internal static double StopMeasCoeff = 0.65;//Измерение прекращается, если амплитуда производной меньше StopMeasCoeff*Max
        internal static double StopMeasPressure = 50;
